    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { to: '/develop/auto_sdk/intro', from: ['/docs/category/develop-using-auto-sdk', '/docs/develop/auto_sdk/intro', '/develop/auto-sdk/intro', '/develop/auto-sdk'] },
          { to: '/develop/auto_sdk/auto-consensus', from: ['/docs/develop/auto_sdk/auto-consensus', '/develop/auto-sdk/consensus'] },
          { to: '/develop/auto_sdk/auto-id', from: ['/docs/develop/auto_sdk/auto-id', '/develop/auto-sdk/auto-id'] },
          { to: '/develop/auto_sdk/auto-xdm', from: ['/docs/develop/auto_sdk/auto-xdm', '/develop/auto-sdk/xdm'] },
          { to: '/develop/auto_sdk/auto-utils', from: ['/docs/develop/auto_sdk/auto-utils', '/develop/auto-sdk/utils'] },

          { to: '/develop/nova/intro', from: ['/docs/category/develop-on-nova-evm', '/docs/develop/nova/quick_start', '/develop/nova/introduction', '/develop/auto-evm/introduction', '/develop/auto-evm', '/develop/nova'] },
          { to: '/develop/nova/general-information', from: ['/docs/develop/nova/general-information', '/develop/nova/general', '/develop/auto-evm/general'] },
          { to: '/develop/nova/setting-up-metamask', from: ['/docs/develop/nova/setting-up-metamask', '/develop/nova/metamask', '/develop/auto-evm/metamask'] },
          { to: '/develop/nova/additional-guides/foundry_guide', from: ['/docs/develop/nova/foundry_guide', '/develop/nova/guides/foundry', '/develop/auto-evm/guides/foundry'] },
          { to: '/develop/nova/additional-guides/hardhat_guide', from: ['/docs/develop/nova/hardhat_guide', '/develop/nova/guides/hardhat', '/develop/auto-evm/guides/hardhat'] },
          { to: '/develop/nova/additional-guides/local_development', from: ['/docs/develop/nova/local_development', '/develop/nova/guides/local-development', '/develop/auto-evm/guides/local-development'] },
          { to: '/develop/nova/additional-guides/remix_guide', from: ['/docs/develop/nova/remix_guide', '/develop/nova/guides/remix', '/develop/auto-evm/guides/remix'] },
          { to: '/develop/nova/Resources/faucet', from: ['/docs/develop/nova/faucet', '/develop/nova/faucet', '/develop/auto-evm/faucet'] },
          { to: '/develop/nova/Resources/block_explorer', from: ['/docs/develop/nova/block_explorer', '/develop/nova/block-explorer', '/develop/auto-evm/block-explorer'] },
