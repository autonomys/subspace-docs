...
<TabItem value="windows" label="🖼️ Windows" default>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        ...
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-node-windows-x86_64-v2-gemini-3f-2023-aug-31.exe">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-farmer-windows-x86_64-v2-gemini-3f-2023-aug-31.exe">
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-node-windows-x86_64-skylake-gemini-3f-2023-aug-31.exe">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-farmer-windows-x86_64-skylake-gemini-3f-2023-aug-31.exe">
        Download Farmer Executable
      </Link>
    </div>
  </details>
...
:::
  ...
  ```powershell
    ...
    .\subspace-farmer-windows-x86_64-skylake-gemini-3f-2023-aug-31.exe farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
  ```
...
<TabItem value="macos" label="🍎macOS" default>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-node-macos-x86_64-gemini-3f-2023-aug-31.zip">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-farmer-macos-x86_64-gemini-3f-2023-aug-31.zip">
        Download Farmer Executable
      </Link>
    </div>
  </details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-node-macos-aarch64-gemini-3f-2023-aug-31.zip">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-farmer-macos-aarch64-gemini-3f-2023-aug-31.zip">
        Download Farmer Executable
      </Link>
    </div>
  </details>
...
:::
  ...
  - `chmod +x subspace-farmer-macos-aarch64-gemini-3f-2023-aug-31`
  - `chmod +x subspace-node-macos-aarch64-gemini-3f-2023-aug-31`
  ...
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-macos-aarch64-gemini-3f-2023-aug-31 \
    --chain gemini-3f \
    --execution wasm \
    --blocks-pruning 256 \
    --state-pruning archive \
  ...
  5. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
   ```bash
    ...
    # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
    # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for example 100G or 2T (but leave at least 60G of disk space for node and some for OS)
    ./subspace-farmer-macos-aarch64-gemini-3f-2023-aug-31 farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
  ```
...
<TabItem value="linux" label="🐧Ubuntu">
  <details>
    ...
    <details>
      ...
      <div className={styles.buttons}>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-node-ubuntu-x86_64-v2-gemini-3f-2023-aug-31">
          Download Node Executable
        </Link>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-farmer-ubuntu-x86_64-v2-gemini-3f-2023-aug-31">
          Download Farmer Executable
        </Link>
      </div>
    </details>
    <details>
      ...
      <div className={styles.buttons}>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-node-ubuntu-x86_64-skylake-gemini-3f-2023-aug-31">
          Download Node Executable
        </Link>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-farmer-ubuntu-x86_64-skylake-gemini-3f-2023-aug-31">
          Download Farmer Executable
        </Link>
      </div>
    </details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-node-ubuntu-aarch64-gemini-3f-2023-aug-31">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-aug-31/subspace-farmer-ubuntu-aarch64-gemini-3f-2023-aug-31">
...
:::
  ...
  1. Open your favorite terminal, and change to the Downloads directory using `cd Downloads`
  2. Make the farmer & node executable
  - `chmod +x subspace-farmer-ubuntu-x86_64-skylake-gemini-3f-2023-aug-31`
  ...
  5. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
   ```bash
    ...
    # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
    # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for example 100G or 2T (but leave at least 60G of disk space for node and some for OS)
    ./subspace-farmer-ubuntu-x86_64-skylake-gemini-3f-2023-aug-31 farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
  ```
