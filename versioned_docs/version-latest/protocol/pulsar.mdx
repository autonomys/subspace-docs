...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-windows-x86_64-v2-v0.6.5-alpha.exe">
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-windows-x86_64-skylake-v0.6.5-alpha.exe">
      Windows CLI Executable
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-macos-x86_64-v0.6.5-alpha.zip">
      Mac CLI Executable (Intel)
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-macos-aarch64-v0.6.5-alpha.zip">
        Mac CLI Executable (Apple M Series)
    </Link>
  </div>
</details>
...
4. Make the binary executable by running:
    * `chmod +x pulsar-macos-x86_64-v0.6.5-alpha` (Intel Chip)
    * `chmod +x pulsar-macos-aarch64-v0.6.5-alpha` (Apple M Series)
...
<details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-ubuntu-x86_64-v2-v0.6.5-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-ubuntu-x86_64-skylake-v0.6.5-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-ubuntu-aarch64-v0.6.5-alpha">
...
3. Make the binary executable by running:
	* `chmod +x pulsar-ubuntu-x86_64-skylake-v0.6.5-alpha` (Ubuntu)
    * `chmod +x pulsar-ubuntu-aarch64-v0.6.5-alpha` (Ubuntu aarch64)
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.5-alpha.exe init
```
...
./pulsar-macos-x86_64-v0.6.5-alpha  init
...
./pulsar-macos-aarch64-v0.6.5-alpha init
...
./pulsar-ubuntu-x86_64-skylake-v0.6.5-alpha  init
...
./pulsar-ubuntu-aarch64-v0.6.5-alpha  init
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.5-alpha.exe farm
```
...
./pulsar-macos-x86_64-v0.6.5-alpha farm
...
./pulsar-macos-aarch64-v0.6.5-alpha farm
...
./pulsar-ubuntu-x86_64-skylake-v0.6.5-alpha farm
...
./pulsar-ubuntu-aarch64-v0.6.5-alpha farm
