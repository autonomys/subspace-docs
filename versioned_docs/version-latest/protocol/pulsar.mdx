...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-windows-x86_64-v2-v0.6.4-alpha.exe">
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-windows-x86_64-skylake-v0.6.4-alpha.exe">
      Windows CLI Executable
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-macos-x86_64-v0.6.4-alpha.zip">
      Mac CLI Executable (Intel)
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-macos-aarch64-v0.6.4-alpha.zip">
        Mac CLI Executable (Apple M Series)
    </Link>
  </div>
</details>
...
<details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-ubuntu-x86_64-v2-v0.6.4-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-ubuntu-x86_64-skylake-v0.6.4-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.5-alpha/pulsar-ubuntu-aarch64-v0.6.4-alpha">
