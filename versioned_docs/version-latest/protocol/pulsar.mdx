...
<details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.6-alpha/pulsar-ubuntu-x86_64-v2-v0.6.6-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.6-alpha/pulsar-ubuntu-x86_64-skylake-v0.6.6-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.6-alpha/pulsar-ubuntu-aarch64-v0.6.6-alpha">
...
3. Make the binary executable by running:
	* `chmod +x pulsar-ubuntu-x86_64-skylake-v0.6.6-alpha` (Ubuntu)
    * `chmod +x pulsar-ubuntu-aarch64-v0.6.6-alpha` (Ubuntu aarch64)
...
```shell-session
./pulsar-ubuntu-aarch64-v0.6.6-alpha  init
```
...
```shell-session
./pulsar-ubuntu-aarch64-v0.6.6-alpha farm
```
