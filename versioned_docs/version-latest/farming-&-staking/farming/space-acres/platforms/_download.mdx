...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    ...
    to="https://github.com/subspace/space-acres/releases/download/0.1.7/space-acres-0.1.7-x86_64.msi"
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/space-acres/releases/download/0.1.7/space-acres_0.1.7-1_amd64.deb"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    ...
    <Link
    className="button button--secondary"
    to="https://github.com/subspace/space-acres/releases/download/0.1.7/space-acres-0.1.7-x86_64.AppImage"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
