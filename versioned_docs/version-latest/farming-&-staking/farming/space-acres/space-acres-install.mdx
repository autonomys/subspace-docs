...
6. Now that Space Acres is set up, your farming operation will begin automatically. Monitor the application for the status of your farming and the accrual of rewards.
