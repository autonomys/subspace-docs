...
:::caution Windows Install Visual C++ Redistributable
Download the [Microsoft Visual C++ Redistributable.](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170)
:::

:::caution Mac Install Visual C++ Redistributable
Download [Visual Studio.](https://visualstudio.microsoft.com/vs/mac/)
:::

:::caution Linux Install Visual C++ Redistributable
Follow These [Instructions.](https://learn.microsoft.com/en-us/cpp/linux/download-install-and-setup-the-linux-development-workload?view=msvc-170#linux-setup-ubuntu-on-wsl)
:::
...
1. The welcome screen provides an overview of the necessary prerequisites for running Space Acres effectively. Make sure you meet all listed requirements before proceeding. For a comprehensive list of prerequisites and explanations, refer to our [prerequisites guide.](../prerequisites)  
