...
|-------|---------------------|---------------------------------------------------------|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| 30333 | TCP/UDP (QUIC)      | Always public                                           | Substrate networking P2P   | <ul><li>[Pulsar](../../../category/pulsar/)</li><li>[Advanced CLI Node (Consensus)](../../../category/advanced-cli-recommended)</li><li>[Space Acres](https://github.com/nazar-pc/space-acres)</li></ul> | Network Connection: <ul><li>Exchanging Blocks</li><li>Exchanging Transactions</li><li>Proof of Time Gossip</li><li>etc.</li></ul> |
| 30433 | TCP/UDP (QUIC)      | Always public                                           | Subspace networking P2P    | <ul><li>[Pulsar](../../../category/pulsar/)</li><li>[Advanced CLI Node (Consensus)](../../../category/advanced-cli-recommended)</li><li>[Space Acres](https://github.com/nazar-pc/space-acres)</li></ul> | Network Connection for Archival History             |
| 30533 | TCP/UDP (QUIC)      | Always public                                           | Subspace networking P2P    | <ul><li>[Advanced CLI Node (Consensus)](../../../category/advanced-cli-recommended)</li></ul>                                                                        | Network Connection & Archival History Retrieval      |
| 40333 | TCP (QUIC)          | Always public                                           | Subspace networking P2P    | <ul><li>[Advanced CLI Node (Domain)](../../../category/operators-and-nominators)</li></ul>                                                                           | Domain Network Connection for domain operations      |
| 9944  | TCP (HTTP/WebSocket)| Public: <ul><li>RPC server</li></ul> Private: <ul><li>Internal node-to-farmer connections</li></ul> | Consensus RPC port         | <ul><li>[Advanced CLI Node (Consensus)](../../../category/advanced-cli-recommended)</li></ul>                                                                        | Public: <ul><li>RPC Server to expose various details about blockchain state</li></ul> Private: <ul><li>Internal communication</li></ul> |
| 9945  | TCP (HTTP/WebSocket)| Public: <ul><li>RPC server</li></ul>                     | Domain RPC port            | <ul><li>[Advanced CLI Node (Domain)](../../../category/operators-and-nominators)</li></ul>                                                                           | <ul><li>RPC Server:</li><ul><li>Blockchain Details<ul><li>Events</li><li>Storage</li><li>Transactions</li></ul></li><li>Submit Transactions<ul><li>Balance Transfers</li><li>Interacting with Smart Contracts</li><li>etc.</li></ul></li></ul></ul> |
