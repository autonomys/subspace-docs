...
--base-path PATH_TO_NODE --domain-id DOMAIN_ID --keystore-suri "<Secret phrase>" --key-type oper --scheme sr25519
```

The command above will insert the keypair in the subfolder of `PATH_TO_NODE/domains/DOMAIN_ID/keystore`.
...
:::note
You need to update the move your keypain to a new location, if you switch domains. Follow the [insert key to keystore section](#insert-key-to-keystore)
:::
