...
services:
  node:
    # Replace snapshot-DATE with the latest release (like snapshot-2023-dec-11)
...
# occurrences of 30333 or 30433 in this file with another value
    ...
    command: [
# Make sure to replace your_domain_id and your_operator_id with your domain ID and operator ID
# Adjust the keystore path to the location where you generated your operator keypair.
      "--chain", "gemini-3g",
      "-- ",
      "--domain-id", "your_domain_id",
      "--operator-id", "your_operator_id",
...
# If node setup takes longer than expected, you want to increase interval and retries number.
    ...
    # Replace snapshot-DATE with latest release (like snapshot-2023-dec-11)
    # For running on Aarch64 add -aarch64 after DATE
