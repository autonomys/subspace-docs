...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    ...
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-nov-16/subspace-node-windows-x86_64-skylake-gemini-3g-2023-nov-16.exe"
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-nov-16/subspace-farmer-windows-x86_64-skylake-gemini-3g-2023-nov-16.exe"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-nov-16/subspace-node-windows-x86_64-v2-gemini-3g-2023-nov-16.exe"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Node Executable</span>
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-nov-16/subspace-farmer-windows-x86_64-v2-gemini-3g-2023-nov-16.exe"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Farmer Executable</span>
    <span style={{ fontSize: '14px' }}>(Legacy CPU)</span>
  </Link>
...
```PowerShell
  ...
  .\subspace-farmer-windows-x86_64-skylake-gemini-3g-2023-nov-16.exe farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
```
