...
6. Set the minimum nominator stake required for nominators to participate under this operator. The value must be an integer equal to or greater than 1 token.
