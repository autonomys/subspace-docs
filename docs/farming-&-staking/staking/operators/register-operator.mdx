...
slug: /domains/operator/register
keywords:
- Operator
- Guide
---
...
You are required to have at least 100 tSSC in order to register your operator. If you are a verified farmer but do not have enough tSSC, you can visit the [Operator Tips & Tricks](/domains/operator/tips) page to find out how to claim 100 tSSC.
:::
