...
2. If you do not see the staking tab, then you are probably have mainnet selected instead of Testnet-Taurus.

![NStaking-0](/img/doc-imgs/operators-staking/NStaking-0.png)

3. Select the wallet you would like to connect. **Subwallet**, **PolkadotJS**, and **Talisman** wallets are supported.

![NStaking-2](/img/doc-imgs/operators-staking/NStaking-2.png)

4. Enter your password to give an access to your wallet.
...
7. Select your Domain (It will default to the Taurus EVM), Signing key, Amount to Stake, Nominator Tax, and a Minimum Nominator Stake.
