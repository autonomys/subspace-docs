---
title: Register a Taurus Operator
sidebar_position: 2
description: Operators Setup guide
slug: /staking/operator/register-taurus
...
import WindowsPage from '/docs/farming-&-staking/staking/operators/platforms/_windows-taurus.mdx';
import MacOSPage from '/docs/farming-&-staking/staking/operators/platforms/_macos-taurus.mdx';
import LinuxPage from '/docs/farming-&-staking/staking/operators/platforms/_linux-taurus.mdx';
...
:::note
This guide is for registering an operator on the **Taurus** network
:::
...
1. Proceed to the staking tab on [Astral](https://astral.autonomys.xyz/taurus/consensus) and make sure you have the Taurus network selected.
...
9. Congratulations, you're now registered as an **operator**!  While still on the `Staking` tab, click on `Operators` and then toggle the filter from `All operators` to `My nominations`. This will allow you to easily find your operator(s) in the list.
...
![NStaking-21](/img/doc-imgs/operators-staking/NStaking-21.png)
...
![NStaking-20](/img/doc-imgs/operators-staking/NStaking-20.png)

:::warning
You cannot withdraw more than the 100 tAI3 minimum operator stake. If you try to withdraw more than the minimum, the request will be rejected.
:::
...
![NStaking-23](/img/doc-imgs/operators-staking/NStaking-23.png)
...
![NStaking-24](/img/doc-imgs/operators-staking/NStaking-24.png)
...
![NStaking-25](/img/doc-imgs/operators-staking/NStaking-25.png)
