...
Our benchmarking tests were conducted using the Intel Core i7-6700 CPU. This hardware configuration has been verified to handle blocks that are 100% full of transactions without performance issues.
