...
Linux has a hard limit of 100k file descriptors. Exceeding this may cause errors. Refer to our guide [here](./advanced-cli/cli-tips.mdx#linux-file-descriptor)
:::