...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
    <Link
        ...
        to="https://github.com/autonomys/space-acres/releases/download/0.1.36/space-acres_0.1.36-1_amd64.deb"
    ...
    <Link
        className="button button--secondary"
        to="https://github.com/autonomys/space-acres/releases/download/0.1.36/space-acres-0.1.36-x86_64.AppImage"
        style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
