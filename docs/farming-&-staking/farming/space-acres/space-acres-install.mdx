...
For those who prefer a visual guide, we have prepared installation videos to assist you. The videos will help you to set up Space Acres. Please select your operating system below to watch the corresponding installation video. If you prefer detailed text instructions, please proceed to [Step 1](#step-1-download-and-install-space-acres).
