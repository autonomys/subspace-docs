...
- **[Advanced CLI](../farming/advanced-cli/cli-install)**: For those who prefer the command line, the Advanced CLI remains available, providing granular control over farming operations.
