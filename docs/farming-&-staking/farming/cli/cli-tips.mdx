...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-jan-14 wipe <PATH_TO_FARM>
./subspace-node-ubuntu-x86_64-skylake-mainnet-2025-jan-14 wipe <BASE_PATH>
```
...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-jan-14 farm --reward-address "<REWARD_ADDRESS>" \
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-jan-14 benchmark audit <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-jan-14 benchmark prove <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-jan-14 scrub <PATH_TO_FARM>
```
