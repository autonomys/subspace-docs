...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-aug-25 wipe <PATH_TO_FARM>
./subspace-node-ubuntu-x86_64-skylake-mainnet-2025-aug-25 wipe <BASE_PATH>
```
...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-aug-25 farm --reward-address "<REWARD_ADDRESS>" \
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-aug-25 benchmark audit <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-aug-25 benchmark prove <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-aug-25 scrub <PATH_TO_FARM>
```
