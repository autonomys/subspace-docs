...
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-jan-14/subspace-node-windows-x86_64-skylake-mainnet-2025-jan-14.exe" title="Node Executable" subtitle="(Skylake+ CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-jan-14/subspace-farmer-windows-x86_64-skylake-mainnet-2025-jan-14.exe" title="Farmer Executable" subtitle="(Skylake+ CPU)" />
</ReleaseContainer>
 
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-jan-14/subspace-node-windows-x86_64-v2-mainnet-2025-jan-14.exe" title="Node Executable" subtitle="(Legacy CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-jan-14/subspace-farmer-windows-x86_64-v2-mainnet-2025-jan-14.exe" title="Farmer Executable" subtitle="(Legacy CPU)" />
</ReleaseContainer>
...
```PowerShell
.\subspace-farmer-windows-x86_64-skylake-mainnet-2025-jan-14.exe farm --reward-address "<REWARD_ADDRESS>" path="<PATH_TO_FARM>,size=<FARM_SIZE>"
```
