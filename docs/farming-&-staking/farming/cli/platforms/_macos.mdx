...
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-aug-25/subspace-node-macos-aarch64-mainnet-2025-aug-25.zip" title="Node Executable" subtitle="(Apple CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-aug-25/subspace-farmer-macos-aarch64-mainnet-2025-aug-25.zip" title="Farmer Executable" subtitle="(Apple CPU)" />
</ReleaseContainer>
...
- `chmod +x subspace-farmer-macos-aarch64-mainnet-2025-aug-25`
- `chmod +x subspace-node-macos-aarch64-mainnet-2025-aug-25`
...
```bash
./subspace-node-macos-aarch64-mainnet-2025-aug-25 \
  run \
  --chain mainnet \
  --base-path "<BASE_PATH>" \
  --farmer \
...
```bash
./subspace-farmer-macos-aarch64-mainnet-2025-aug-25 farm --reward-address \"<REWARD_ADDRESS>\" path=\"<PATH_TO_FARM>,size=<FARM_SIZE>\"
```
