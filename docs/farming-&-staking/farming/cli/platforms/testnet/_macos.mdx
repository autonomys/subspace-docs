...
<ReleaseContainer>
  ...
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-farmer-macos-aarch64-taurus-2025-jul-14.zip" title="Farmer Executable" subtitle="(Apple CPU)" />
</ReleaseContainer>
...
- `chmod +x subspace-farmer-macos-aarch64-taurus-2025-jul-14`
- `chmod +x subspace-node-macos-aarch64-taurus-2025-jul-14`
...
```bash
./subspace-node-macos-aarch64-taurus-2025-jul-14 \
  run \
  --chain taurus \
  --base-path "<BASE_PATH>" \
  --farmer \
...
```bash
./subspace-farmer-macos-aarch64-taurus-2025-jul-14 farm --reward-address "<REWARD_ADDRESS>" path="<PATH_TO_FARM>,size=<FARM_SIZE>"
```
