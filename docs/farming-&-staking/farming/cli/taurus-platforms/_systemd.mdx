...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-node-ubuntu-x86_64-v2-taurus-2025-jul-14
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-farmer-ubuntu-x86_64-v2-taurus-2025-jul-14
		```
    </details>
    <details>
        <summary>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-node-ubuntu-x86_64-skylake-taurus-2025-jul-14
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-jul-14
		```
    </details>
</details>
...
<details>
	...
	Node:
	```bash
	wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-node-ubuntu-aarch64-taurus-2025-jul-14
	```
	Farmer:
	```bash
	wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-farmer-ubuntu-aarch64-taurus-2025-jul-14
	```
</details>
