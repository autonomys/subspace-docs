...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/taurus-2025-march-05/subspace-node-ubuntu-x86_64-v2-taurus-2025-march-05`}
		</CodeBlock>
		Farmer:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/taurus-2025-march-05/subspace-farmer-ubuntu-x86_64-v2-taurus-2025-march-05`}
		</CodeBlock>
    </details>
    <details>
        <summary>
		...
		Node:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/taurus-2025-march-05/subspace-node-ubuntu-x86_64-skylake-taurus-2025-march-05`}
		</CodeBlock>
		Farmer:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/taurus-2025-march-05/subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-march-05`}
		</CodeBlock>
    </details>
</details>
...
<details>
	...
	Node:
	<CodeBlock language="shell-session">
	{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/taurus-2025-march-05/subspace-node-ubuntu-aarch64-taurus-2025-march-05`}
	</CodeBlock>
	Farmer:
	<CodeBlock language="shell-session">
	{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/taurus-2025-march-05/subspace-farmer-ubuntu-aarch64-taurus-2025-march-05`}
	</CodeBlock>
</details>
