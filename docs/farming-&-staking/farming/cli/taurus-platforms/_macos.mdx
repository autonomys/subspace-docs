...
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-may-27/subspace-node-macos-aarch64-taurus-2025-may-27.zip" title="Node Executable" subtitle="(Apple CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-may-27/subspace-farmer-macos-aarch64-taurus-2025-may-27.zip" title="Farmer Executable" subtitle="(Apple CPU)" />
</ReleaseContainer>
...
- `chmod +x subspace-farmer-macos-aarch64-taurus-2025-may-27`
- `chmod +x subspace-node-macos-aarch64-taurus-2025-may-27`
...
```bash
./subspace-node-macos-aarch64-taurus-2025-may-27 \
  run \
  --chain taurus \
  --base-path "<BASE_PATH>" \
  --farmer \
...
2022-02-03 10:52:23 📋 Chain specification: Autonomys Taurus Testnet
...
```bash
./subspace-farmer-macos-aarch64-taurus-2025-may-27 farm --reward-address "<REWARD_ADDRESS>" path="<PATH_TO_FARM>,size=<FARM_SIZE>"
```
