...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    ...
    to="https://github.com/autonomys/subspace/releases/download/taurus-2025-mar-17/subspace-node-ubuntu-x86_64-skylake-taurus-2025-mar-17"
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/autonomys/subspace/releases/download/taurus-2025-mar-17/subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-mar-17"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    className="button button--secondary"
    to="https://github.com/autonomys/subspace/releases/download/taurus-2025-mar-17/subspace-node-ubuntu-x86_64-v2-taurus-2025-mar-17"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Node Executable</span>
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/autonomys/subspace/releases/download/taurus-2025-mar-17/subspace-farmer-ubuntu-x86_64-v2-taurus-2025-mar-17"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Farmer Executable</span>
    <span style={{ fontSize: '14px' }}>(Legacy CPU)</span>
  </Link>
...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    className="button button--secondary"
    to="https://github.com/autonomys/subspace/releases/download/taurus-2025-mar-17/subspace-node-ubuntu-aarch64-taurus-2025-mar-17"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Node Executable</span>
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/autonomys/subspace/releases/download/taurus-2025-mar-17/subspace-farmer-ubuntu-aarch64-taurus-2025-mar-17"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Farmer Executable</span>
    <span style={{ fontSize: '14px' }}>(Aarch64/Raspberry Pi)</span>
  </Link>
...
2. Make the `farmer` and `node` executable:
    ```bash
    chmod +x subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-mar-17
    chmod +x subspace-node-ubuntu-x86_64-skylake-taurus-2025-mar-17
    ```
...
3. Start the node using the command below. Replace `<NODE_DATA_PATH>` with the path where you want to store the node database and `<YOUR_NODE_NAME>` with a nickname of your choice. Ensure you copy the entire command:
    ...
    ```bash
    ./subspace-node-ubuntu-x86_64-skylake-taurus-2025-mar-17 \
      run \
      --chain taurus \
...
1. Open a new terminal and navigate to the directory where the Subspace farmer binary is located. Start the farmer with the following command:
    ...
    ./subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-mar-17 farm \
