...
Linux systems may have a default file descriptor limit, which can vary based on distribuition. Exceeding this limit could cause errors. For detailed information, visit our [Tips & Tricks](/farming/cli/tips#changing-number-of-open-files-limit-linux) guide.
