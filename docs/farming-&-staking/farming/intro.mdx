...
| --- | --- | :-: | :-: | :-: |
| Minimum [¹](https://docs.autonomys.xyz/farming/intro#min-hardware) | 4 Cores+ | 8GB | 100GiB [²](https://docs.autonomys.xyz/farming/intro#min-node-storage) | 100GiB |
...
<br />
<p>
<small>² While 100GiB is sufficient for running a farming node, a domain node will require more than 100GiB of storage.</small>
<br />
<small>³ Storage contribution impacts block and vote rewards on the Autonomys Network. More farmed sectors will lead to faster and more frequent rewards. You can start with as little as 100GiB, but allocating more will maximize your reward potential.</small>
<br />
</p>
...
The farmer employs checksums for data integrity and can recover from corrupted blocks. Striping provides no benefits and raises the risk of needing to refarm multiple drives instead of just one.
</TabItem>
