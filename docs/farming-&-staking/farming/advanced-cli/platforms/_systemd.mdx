...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/gemini-3h-2024-sep-17/subspace-node-ubuntu-x86_64-v2-gemini-3h-2024-sep-17`}
		</CodeBlock>
		Farmer:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/gemini-3h-2024-sep-17/subspace-farmer-ubuntu-x86_64-v2-gemini-3h-2024-sep-17`}
		</CodeBlock>
    </details>
    <details>
        <summary>
		...
		Node:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/gemini-3h-2024-sep-17/subspace-node-ubuntu-x86_64-skylake-gemini-3h-2024-sep-17`}
		</CodeBlock>
		Farmer:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/gemini-3h-2024-sep-17/subspace-farmer-ubuntu-x86_64-skylake-gemini-3h-2024-sep-17`}
		</CodeBlock>
    </details>
</details>
...
<details>
	...
	Node:
	<CodeBlock language="shell-session">
	{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/gemini-3h-2024-sep-17/subspace-node-ubuntu-aarch64-gemini-3h-2024-sep-17`}
	</CodeBlock>
	Farmer:
	<CodeBlock language="shell-session">
	{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/gemini-3h-2024-sep-17/subspace-farmer-ubuntu-aarch64-gemini-3h-2024-sep-17`}
	</CodeBlock>
</details>
