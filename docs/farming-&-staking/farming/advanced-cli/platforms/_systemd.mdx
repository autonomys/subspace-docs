...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-12/subspace-node-ubuntu-x86_64-v2-mainnet-2024-nov-12`}
		</CodeBlock>
		Farmer:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-12/subspace-farmer-ubuntu-x86_64-v2-mainnet-2024-nov-12`}
		</CodeBlock>
    </details>
    <details>
        <summary>
		...
		Node:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-12/subspace-node-ubuntu-x86_64-skylake-mainnet-2024-nov-12`}
		</CodeBlock>
		Farmer:
		<CodeBlock language="shell-session">
		{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-12/subspace-farmer-ubuntu-x86_64-skylake-mainnet-2024-nov-12`}
		</CodeBlock>
    </details>
</details>
...
<details>
	...
	Node:
	<CodeBlock language="shell-session">
	{`wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-12/subspace-node-ubuntu-aarch64-mainnet-2024-nov-12`}
	</CodeBlock>
	Farmer:
	<CodeBlock language="shell-session">
	{`wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-12/subspace-farmer-ubuntu-aarch64-mainnet-2024-nov-12`}
	</CodeBlock>
</details>
