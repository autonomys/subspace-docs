...
- `chmod +x subspace-farmer-ubuntu-x86_64-skylake-gemini-3g-2024-jan-31`
- `chmod +x subspace-node-ubuntu-x86_64-skylake-gemini-3g-2024-jan-31`
...
./subspace-farmer-ubuntu-x86_64-skylake-gemini-3g-2024-jan-31 farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
```
