...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    ...
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-dec-11/subspace-node-ubuntu-x86_64-skylake-gemini-3g-2023-dec-11"
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-dec-11/subspace-farmer-ubuntu-x86_64-skylake-gemini-3g-2023-dec-11"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-dec-11/subspace-node-ubuntu-x86_64-v2-gemini-3g-2023-dec-11"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Node Executable</span>
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-dec-11/subspace-farmer-ubuntu-x86_64-v2-gemini-3g-2023-dec-11"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Farmer Executable</span>
    <span style={{ fontSize: '14px' }}>(Legacy CPU)</span>
  </Link>
...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-dec-11/subspace-node-ubuntu-aarch64-gemini-3g-2023-dec-11"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Node Executable</span>
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/subspace/subspace/releases/download/gemini-3g-2023-dec-11/subspace-farmer-ubuntu-aarch64-gemini-3g-2023-dec-11"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
    <span style={{ fontSize: '20px' }}>Farmer Executable</span>
    <span style={{ fontSize: '14px' }}>(Aarch64/Raspberry Pi)</span>
  </Link>
...
- `chmod +x subspace-farmer-ubuntu-x86_64-skylake-gemini-3g-2023-dec-11`
- `chmod +x subspace-node-ubuntu-x86_64-skylake-gemini-3g-2023-dec-11`
3. We will then start the node using the following command

```bash
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-ubuntu-x86_64-skylake-gemini-3g-2023-dec-11 \
    --chain gemini-3g \
    --blocks-pruning 256 \
...
1. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
  ...
  ./subspace-farmer-ubuntu-x86_64-skylake-gemini-3g-2023-dec-11 farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
```
