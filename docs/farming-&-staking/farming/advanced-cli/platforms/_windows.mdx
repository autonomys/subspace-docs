...
<Columns>
  <Column>
    <Card>
      ...
      <div className="button-group button-group--block">
        <a href="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-node-windows-x86_64-skylake-mainnet-2024-nov-28.exe" className="button button--secondary">Skylake+ ¹</a>
        <a href="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-node-windows-x86_64-v2-mainnet-2024-nov-28.exe" className="button button--secondary">Legacy ²</a>
      </div>
      </CardFooter>
    </Card>
    <br />
  ...
  <Column>
    <Card>
      ...
      >
      <div className="button-group button-group--block">
        <a href="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-farmer-windows-x86_64-skylake-mainnet-2024-nov-28.exe" className="button button--secondary">Skylake+ ¹</a>
        <a href="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-farmer-windows-x86_64-v2-mainnet-2024-nov-28.exe" className="button button--secondary">Legacy ²</a>
      </div>
      </CardFooter>
    </Card>
  </Column>
...
3. We will then start the node using the following command:
    ...
    ```powershell title="💡 Highlighted lines require parameter updates."
...
4. You should see similar output when starting your node:
    ...
    2024-09-04T06:42:56.744243Z  INFO subspace_node::commands::run: 💾 Node path: C:\Users\X\AppData\Local\autonomys\db
