...
<div className={`${styles.buttons} ${styles.flexContainer}`}>
  <Link
    ...
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-13/subspace-node-macos-aarch64-mainnet-2024-nov-13.zip"
  ...
  <Link
    className="button button--secondary"
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-13/subspace-farmer-macos-aarch64-mainnet-2024-nov-13.zip"
    style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '10px' }}>
...
- `chmod +x subspace-farmer-macos-aarch64-mainnet-2024-nov-13`
- `chmod +x subspace-node-macos-aarch64-mainnet-2024-nov-13`
