...
<Columns>
  <Column>
    <Card>
      ...
      <div className="button-group button-group--block">
        <a href="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-node-macos-aarch64-mainnet-2024-nov-28.zip" className="button button--secondary">Apple Silicon</a>
      </div>
      </CardFooter>
    </Card>
    <br />
  ...
  <Column>
    <Card>
      ...
      >
      <div className="button-group button-group--block">
        <a href="https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-farmer-macos-aarch64-mainnet-2024-nov-28.zip" className="button button--secondary">Apple Silicon</a>
      </div>
      </CardFooter>
    </Card>
  </Column>
...
1. Open a new terminal and navigate to the directory where the Subspace farmer binary is located. Start the farmer with the following command:
    ...
    :::
      ...
      ./subspace-farmer-macos-aarch64-mainnet-2024-nov-28 farm \
