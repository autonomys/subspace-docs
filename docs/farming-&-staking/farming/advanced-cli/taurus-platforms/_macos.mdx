...
<Columns>
  <Column>
    <Card>
      ...
      <div className="button-group button-group--block">
        <a href="https://github.com/autonomys/subspace/releases/download/taurus-2024-nov-05/subspace-node-macos-aarch64-taurus-2024-nov-05.zip" className="button button--secondary">Apple Silicon</a>
      </div>
      </CardFooter>
    </Card>
    <br />
  ...
  <Column>
    <Card>
      ...
      >
      <div className="button-group button-group--block">
        <a href="https://github.com/autonomys/subspace/releases/download/taurus-2024-nov-05/subspace-farmer-macos-aarch64-taurus-2024-nov-05.zip" className="button button--secondary">Apple Silicon</a>
      </div>
      </CardFooter>
    </Card>
  </Column>
...
:::tip Allowing Execution of the Node

When attempting to start the node, you may receive a prompt. Click `Cancel` rather than moving it to the trash.  
To enable execution, navigate to `System Preferences -> Security & Privacy -> General` and click `Allow`.  
Then, repeat the previous step. This time, select `Open` when prompted.
...
4. You should see similar output when starting your node:
    ...
    2024-09-04T06:42:56.744243Z  INFO subspace_node::commands::run: 💾 Node path: /Users/X/Library/Application Support/subspace/db
...
1. Open a new terminal and navigate to the directory where the Subspace farmer binary is located. Start the farmer with the following command:
    ...
    :::
      ...
      ./subspace-farmer-macos-aarch64-taurus-2024-nov-05 farm \
