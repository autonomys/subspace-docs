...
<small>Last Confirmed: mainnet-2024-nov-13-2</small>
</details>
...
The drive where you are storing your farm is out of space. Reduce the farm size and restart the farmer. Additionally, ensure that you are saving the farm to the correct drive and that it is properly mounted.
...
- Ensure you are using the latest release of either [Space Acres](https://github.com/autonomys/space-acres/releases) or the [CLI](https://github.com/autonomys/subspace/releases).
