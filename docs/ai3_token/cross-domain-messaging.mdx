...
A user-friendly web interface for XDM transfers has been developed by a community member and is published at [ai3-xdm-bridge-xi.vercel.app](https://ai3-xdm-bridge-xi.vercel.app/).
