...
A user-friendly web interface for XDM transfers has been developed by the community and is available at [ai3-xdm-bridge-xi.vercel.app](https://ai3-xdm-bridge-xi.vercel.app/).

This interface provides a simplified alternative to using PolkadotJS directly, with a more intuitive user experience for cross-domain transfers.

**Source Code:** The project has been forked to the Autonomys community organization and is available at [github.com/autonomys-community/ai3-xdm-bridge](https://github.com/autonomys-community/ai3-xdm-bridge).

:::caution Community Tool
...
![XDMtool](/img/doc-imgs/additional-guides/XDM-4.png)
