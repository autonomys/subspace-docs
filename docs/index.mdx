...
**Getting Started:**
- **[Space Acres](/farming/space-acres/install)** <Badge variant="recommended" text="Recommended" /> - User-friendly GUI application that simplifies farming with visual setup, monitoring, and the most common configuration options
