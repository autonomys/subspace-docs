...
<TabItem value="windows" label="🖼️ Windows" default>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        ...
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-node-windows-x86_64-v2-gemini-3f-2023-oct-06.exe">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-farmer-windows-x86_64-v2-gemini-3f-2023-oct-06.exe">
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-node-windows-x86_64-skylake-gemini-3f-2023-oct-06.exe">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-farmer-windows-x86_64-skylake-gemini-3f-2023-oct-06.exe">
        Download Farmer Executable
      </Link>
    </div>
  </details>
...
:::
  ...
  ```PowerShell
    ...
    .\subspace-farmer-windows-x86_64-skylake-gemini-3f-2023-oct-06.exe farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
  ```
...
<TabItem value="macos" label="🍎macOS" default>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-node-macos-x86_64-gemini-3f-2023-oct-06.zip">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-farmer-macos-x86_64-gemini-3f-2023-oct-06.zip">
        Download Farmer Executable
      </Link>
    </div>
  </details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-node-macos-aarch64-gemini-3f-2023-oct-06.zip">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-farmer-macos-aarch64-gemini-3f-2023-oct-06.zip">
        Download Farmer Executable
      </Link>
    </div>
  </details>
...
:::
  ...
  5. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
   ```bash
    ...
    # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
    # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for example 100G or 2T (but leave at least 60G of disk space for node and some for OS)
    ./subspace-farmer-macos-aarch64-gemini-3f-2023-oct-06 farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
  ```
...
<TabItem value="linux" label="🐧Ubuntu">
  <details>
    ...
    <details>
      ...
      <div className={styles.buttons}>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-node-ubuntu-x86_64-v2-gemini-3f-2023-oct-06">
          Download Node Executable
        </Link>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-farmer-ubuntu-x86_64-v2-gemini-3f-2023-oct-06">
          Download Farmer Executable
        </Link>
      </div>
    </details>
    <details>
      ...
      <div className={styles.buttons}>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-node-ubuntu-x86_64-skylake-gemini-3f-2023-oct-06">
          Download Node Executable
        </Link>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-farmer-ubuntu-x86_64-skylake-gemini-3f-2023-oct-06">
          Download Farmer Executable
        </Link>
      </div>
    </details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-node-ubuntu-aarch64-gemini-3f-2023-oct-06">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3f-2023-oct-06/subspace-farmer-ubuntu-aarch64-gemini-3f-2023-oct-06">
...
:::
  ...
  5. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
   ```bash
    ...
    # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
    # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for example 100G or 2T (but leave at least 60G of disk space for node and some for OS)
    ./subspace-farmer-ubuntu-x86_64-skylake-gemini-3f-2023-oct-06 farm --reward-address WALLET_ADDRESS path=PATH_TO_FARM,size=PLOT_SIZE
  ```
...
While it might be tempting to adjust certain parameters that seem related to DSN Syncing, it's advised to be cautious. Some options might not enhance syncing and are best left at their default values:
...
The default parameters are set with the capabilities of common consumer modem/routers in mind. Adjusting certain parameters can enhance DSN sync performance. However, if you decide to increase these parameters significantly, ensure that your modem/router is performant enough to handle the increased traffic.
