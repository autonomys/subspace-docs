...
**Example:**
```
.\subspace-node-ubuntu-x86_64-v3-gemini-3d-2023-apr-18 --chain gemini-3d --base-path /path/to/directory/here --execution wasm --state-pruning archive --validator --name INSERT_YOUR_ID
```
</TabItem>
