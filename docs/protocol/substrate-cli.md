...
<TabItem value="windows" label="🖼️ Windows" default>
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-node-windows-x86_64-gemini-3c-2023-mar-14.exe">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-farmer-windows-x86_64-gemini-3c-2023-mar-14.exe">
      Download Farmer Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-farmer-opencl-windows-x86_64-gemini-3c-2023-mar-14.exe">
...
:::
  ...
  .\subspace-node-windows-x86_64-gemini-3c-2023-mar-14.exe `
    --chain gemini-3c `
    --execution wasm `
    --blocks-pruning archive `
    --state-pruning archive `
  ...
  6. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
    *Change command to feature `subspace-farmer-opencl-windows-x86_64-gemini-3c-2023-mar-14.exe` if using Open CL version.*
  ```PowerShell
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  .\subspace-farmer-windows-x86_64-gemini-3c-2023-mar-14.exe farm  `
    --disable-private-ips `
    --reward-address WALLET_ADDRESS `
    --plot-size 10G
  ```
...
<TabItem value="macos" label="🍎macOS" default>
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-node-macos-x86_64-gemini-3c-2023-mar-14.zip">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-farmer-macos-x86_64-gemini-3c-2023-mar-14.zip">
      Download Farmer Executable
    </Link>
  </div>
...
:::
  ...
  - `chmod +x subspace-farmer-macos-x86_64-gemini-3c-2023-mar-14`
  - `chmod +x subspace-node-macos-x86_64-gemini-3c-2023-mar-14`
  3. We will then start the node using the following command
  ...
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-macos-x86_64-gemini-3c-2023-mar-14 \
    --chain gemini-3c \
    --execution wasm \
    --blocks-pruning archive \
    --state-pruning archive \
  ...
  ```bash
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  ./subspace-farmer-macos-x86_64-gemini-3c-2023-mar-14 farm \
    --disable-private-ips \
    --reward-address WALLET_ADDRESS \
    --plot-size 10G
  ```
...
<TabItem value="linux" label="🐧Ubuntu">
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-node-ubuntu-x86_64-gemini-3c-2023-mar-14">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-farmer-ubuntu-x86_64-gemini-3c-2023-mar-14">
      Download Farmer Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-farmer-opencl-ubuntu-x86_64-gemini-3c-2023-mar-14">
      Download Farmer Executable (OpenCL)
    </Link>
  </div>
  <p>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-node-ubuntu-aarch64-gemini-3c-2023-mar-14">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3c-2023-mar-14/subspace-farmer-ubuntu-aarch64-gemini-3c-2023-mar-14">
  ...
  1. Open your favorite terminal, and change to the Downloads directory using `cd Downloads`
  2. Make the farmer & node executable
  - `chmod +x subspace-farmer-ubuntu-x86_64-gemini-3c-2023-mar-14`
  - `chmod +x subspace-node-ubuntu-x86_64-gemini-3c-2023-mar-14`
  3. We will then start the node using the following command

  ```bash
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-ubuntu-x86_64-gemini-3c-2023-mar-14 \
    --chain gemini-3c \
    --execution wasm \
    --blocks-pruning archive \
    --state-pruning archive \
  ...
  ```
  5. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
      *Change command to feature `subspace-farmer-opencl-ubuntu-x86_64-gemini-3c-2023-mar-14` if using openCL.* 
  ```bash
  # Replace `FARMER_FILE_NAME` with the name of the farmer file you downloaded from releases
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  ./subspace-farmer-ubuntu-x86_64-gemini-3c-2023-mar-14 farm \
    --disable-private-ips \
    --reward-address WALLET_ADDRESS \
    --plot-size 10G
  ```
...
**- [Block Explorer](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Feu-0.gemini-3c.subspace.network%2Fws#/accounts)**
...
**Example:**
```
.\subspace-farmer-ubuntu-x86_64-gemini-3c-2023-mar-14 --base-path /path/to/directory/here farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
```
</TabItem>
</Tabs>
...
Now clone the source and build snapshot `gemini-3c-2023-mar-14` (replace occurrences with the snapshot you want to build):
```bash
git clone https://github.com/subspace/subspace.git
cd subspace
git checkout gemini-3c-2023-mar-14
cargo build \
    --profile production \
    --bin subspace-node \
    --bin subspace-farmer
