  ...
  ```yml
    ...
    services:
      node:
        ...
        image: ghcr.io/subspace/node:gemini-3d-2023-may-15
        volumes:
    ...
    # If node setup takes longer than expected, you want to increase `interval` and `retries` number.
      ...
      farmer:
        ...
        # For running on Aarch64 add `-aarch64` after `DATE`
        image: ghcr.io/subspace/farmer:gemini-3d-2023-may-15
        volumes:
    # Instead of specifying volume (which will store data in `/var/lib/docker`), you can
    # alternatively specify path to the directory where files will be stored, just make
    # sure everyone is allowed to write there
...
<TabItem value="windows" label="🖼️ Windows" default>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        ...
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-node-windows-x86_64-v2-gemini-3d-2023-may-15.exe">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-farmer-windows-x86_64-v2-gemini-3d-2023-may-15.exe">
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-node-windows-x86_64-v3-gemini-3d-2023-may-15.exe">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
...
:::
  ...
  .\subspace-node-windows-x86_64-v3-gemini-3d-2023-may-15.exe `
    --chain gemini-3d `
    --execution wasm `
    --blocks-pruning archive `
    --state-pruning archive `
  ...
  .\subspace-farmer-windows-x86_64-v2-gemini-3d-2023-may-15.exe farm  `
    --disable-private-ips `
    --reward-address WALLET_ADDRESS `
    --plot-size 10G
  ```
...
<TabItem value="macos" label="🍎macOS" default>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-node-macos-x86_64-gemini-3d-2023-may-15.zip">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-farmer-macos-x86_64-gemini-3d-2023-may-15.zip">
        Download Farmer Executable
      </Link>
    </div>
  </details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-node-macos-aarch64-gemini-3d-2023-may-15.zip">
        Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-farmer-macos-aarch64-gemini-3d-2023-may-15.zip">
        Download Farmer Executable
      </Link>
    </div>
  </details>
...
:::
  ...
  - `chmod +x subspace-farmer-macos-x86_64-gemini-3d-2023-may-15`
  - `chmod +x subspace-node-macos-x86_64-gemini-3d-2023-may-15`
  ...
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-macos-x86_64-gemini-3d-2023-may-15 \
    --chain gemini-3d \
    --execution wasm \
    --blocks-pruning archive \
    --state-pruning archive \
  ...
  ```bash
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  ./subspace-farmer-macos-x86_64-gemini-3d-2023-may-15 farm \
    --disable-private-ips \
    --reward-address WALLET_ADDRESS \
    --plot-size 10G
  ```
...
<TabItem value="linux" label="🐧Ubuntu">
  <details>
    ...
    <details>
      ...
      <div className={styles.buttons}>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-node-ubuntu-x86_64-v2-gemini-3d-2023-may-15">
          Download Node Executable
        </Link>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-farmer-ubuntu-x86_64-v2-gemini-3d-2023-may-15">
          Download Farmer Executable
        </Link>
      </div>
    </details>
    <details>
      ...
      <div className={styles.buttons}>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-node-ubuntu-x86_64-v3-gemini-3d-2023-may-15">
          Download Node Executable
        </Link>
        <Link
          className="button button--secondary button"
          to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-farmer-ubuntu-x86_64-v3-gemini-3d-2023-may-15">
          Download Farmer Executable
        </Link>
      </div>
    </details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-node-ubuntu-aarch64-gemini-3d-2023-may-15">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-3d-2023-may-15/subspace-farmer-ubuntu-aarch64-gemini-3d-2023-may-15">
...
**Example:**
```
.\subspace-farmer-ubuntu-x86_64-v3-gemini-3d-2023-may-15 --base-path /path/to/directory/here farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
```
</TabItem>
</Tabs>
