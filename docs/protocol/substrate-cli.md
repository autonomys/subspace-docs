...
**Example:**
```
.\subspace-node-ubuntu-x86_64-skylake-gemini-3e-2023-jun-30 --chain gemini-3e --base-path /path/to/directory/here --execution wasm --state-pruning archive --validator --name INSERT_YOUR_ID
```
</TabItem>
