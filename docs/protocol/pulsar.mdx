...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/pulsar/releases/download/v0.6.7-alpha/pulsar-windows-x86_64-v2-v0.6.7-alpha.exe">
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.7-alpha/pulsar-windows-x86_64-skylake-v0.6.7-alpha.exe">
      Windows CLI Executable
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.7-alpha/pulsar-macos-x86_64-v0.6.7-alpha.zip">
      Mac CLI Executable (Intel)
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.7-alpha/pulsar-macos-aarch64-v0.6.7-alpha.zip">
        Mac CLI Executable (Apple M Series)
    </Link>
  </div>
</details>
...
4. Make the binary executable by running:
    * `chmod +x pulsar-macos-x86_64-v0.6.7-alpha` (Intel Chip)
    * `chmod +x pulsar-macos-aarch64-v0.6.7-alpha` (Apple M Series)
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.7-alpha.exe init
```
...
```shell-session
./pulsar-macos-x86_64-v0.6.7-alpha  init
```
Apple M Series:

```shell-session
./pulsar-macos-aarch64-v0.6.7-alpha init
```
...
```shell-session
./pulsar-ubuntu-x86_64-skylake-v0.6.7-alpha  init
```
Ubuntu Executable (aarch64):
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.7-alpha.exe farm
```
...
```shell-session
./pulsar-macos-x86_64-v0.6.7-alpha farm
```
Apple M1 Chip:

```shell-session
./pulsar-macos-aarch64-v0.6.7-alpha farm
```
