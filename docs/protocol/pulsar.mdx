...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/pulsar/releases/download/v0.6.11-alpha/pulsar-windows-x86_64-v2-v0.6.11-alpha.exe">
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.11-alpha/pulsar-windows-x86_64-skylake-v0.6.11-alpha.exe">
      Windows CLI Executable
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.11-alpha/pulsar-macos-x86_64-v0.6.11-alpha.zip">
      Mac CLI Executable (Intel)
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.11-alpha/pulsar-macos-aarch64-v0.6.11-alpha.zip">
        Mac CLI Executable (Apple M Series)
    </Link>
  </div>
</details>
...
4. Make the binary executable by running:
    * `chmod +x pulsar-macos-x86_64-v0.6.11-alpha` (Intel Chip)
    * `chmod +x pulsar-macos-aarch64-v0.6.11-alpha` (Apple M Series)
...
<details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.11-alpha/pulsar-ubuntu-x86_64-v2-v0.6.11-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.11-alpha/pulsar-ubuntu-x86_64-skylake-v0.6.11-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.11-alpha/pulsar-ubuntu-aarch64-v0.6.11-alpha">
...
3. Make the binary executable by running:
	* `chmod +x pulsar-ubuntu-x86_64-skylake-v0.6.11-alpha` (Ubuntu)
    * `chmod +x pulsar-ubuntu-aarch64-v0.6.11-alpha` (Ubuntu aarch64)
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.11-alpha.exe init
```
...
```shell-session
./pulsar-macos-x86_64-v0.6.11-alpha  init
```
Apple M Series:

```shell-session
./pulsar-macos-aarch64-v0.6.11-alpha init
```
...
```shell-session
./pulsar-ubuntu-aarch64-v0.6.11-alpha  init
```
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.11-alpha.exe farm
```
...
```shell-session
./pulsar-macos-x86_64-v0.6.11-alpha farm
```
Apple M1 Chip:

```shell-session
./pulsar-macos-aarch64-v0.6.11-alpha farm
```
...
```shell-session
./pulsar-ubuntu-aarch64-v0.6.11-alpha farm
```
