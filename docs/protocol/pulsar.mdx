...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/pulsar/releases/download/v0.6.2-alpha/pulsar-windows-x86_64-v2-v0.6.2-alpha.exe">
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.2-alpha/pulsar-windows-x86_64-skylake-v0.6.2-alpha.exe">
      Windows CLI Executable
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/pulsar/releases/download/v0.6.2-alpha/pulsar-macos-x86_64-v0.6.2-alpha.zip">
      Mac CLI Executable (Intel)
    </Link>
  </div>
</details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.2-alpha/pulsar-macos-aarch64-v0.6.2-alpha.zip">
        Mac CLI Executable (Apple M Series)
    </Link>
  </div>
</details>
...
4. Make the binary executable by running:
    * `chmod +x pulsar-macos-x86_64-v0.6.2-alpha` (Intel Chip)
    * `chmod +x pulsar-macos-aarch64-v0.6.2-alpha` (Apple M Series)
...
<details>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.2-alpha/pulsar-ubuntu-x86_64-v2-v0.6.2-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
  <details>
    ...
    <div className={styles.buttons}>
      <Link
          className="button button--secondary button"
          to="https://github.com/subspace/pulsar/releases/download/v0.6.2-alpha/pulsar-ubuntu-x86_64-skylake-v0.6.2-alpha">
          Ubuntu Executable
      </Link>
    </div>
  </details>
...
<details>
  ...
  <div className={styles.buttons}>
    <Link
        className="button button--secondary button"
        to="https://github.com/subspace/pulsar/releases/download/v0.6.2-alpha/pulsar-ubuntu-aarch64-v0.6.2-alpha">
...
3. Make the binary executable by running:
	* `chmod +x pulsar-ubuntu-x86_64-skylake-v0.6.2-alpha` (Ubuntu)
    * `chmod +x pulsar-ubuntu-aarch64-v0.6.2-alpha` (Ubuntu aarch64)
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.2-alpha.exe init
```
...
./pulsar-macos-x86_64-v0.6.2-alpha  init
...
./pulsar-macos-aarch64-v0.6.2-alpha init
...
./pulsar-ubuntu-aarch64-v0.6.2-alpha  init
...
Specify a path for storing plot files (press enter to use the default: `"/home/username/.local/share/pulsar/plots"`):
...
```powershell
./pulsar-windows-x86_64-skylake-v0.6.2-alpha.exe farm
```
...
./pulsar-macos-x86_64-v0.6.2-alpha farm
...
./pulsar-macos-aarch64-v0.6.2-alpha farm
...
./pulsar-ubuntu-aarch64-v0.6.2-alpha farm
...
Initial plotting for plot: #0 (/home/username/.local/share/pulsar/plots)
⠁ [00:00:00] 3% [=>                                      ]
