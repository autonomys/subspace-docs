...
<ReleaseContainer>
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-node-macos-aarch64-mainnet-2025-dec-02.zip" 
    title="Node Executable" 
    subtitle="(Apple CPU)" />
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-farmer-macos-aarch64-mainnet-2025-dec-02.zip" 
...
- `chmod +x subspace-farmer-macos-aarch64-mainnet-2025-dec-02`
- `chmod +x subspace-node-macos-aarch64-mainnet-2025-dec-02`
...
```bash
./subspace-node-macos-aarch64-mainnet-2025-dec-02 \
  run \
  --chain mainnet \
  --base-path "<BASE_PATH>" \
  --farmer \
...
```bash
./subspace-farmer-macos-aarch64-mainnet-2025-dec-02 farm --reward-address \"<REWARD_ADDRESS>\" path=\"<PATH_TO_FARM>,size=<FARM_SIZE>\"
```
