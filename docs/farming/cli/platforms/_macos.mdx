...
<ReleaseContainer>
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-08/subspace-node-macos-aarch64-mainnet-2026-jun-08.zip" 
    title="Node Executable" 
    subtitle="(Apple CPU)" />
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-08/subspace-farmer-macos-aarch64-mainnet-2026-jun-08.zip" 
...
- `chmod +x subspace-farmer-macos-aarch64-mainnet-2026-jun-08`
- `chmod +x subspace-node-macos-aarch64-mainnet-2026-jun-08`
...
```bash
./subspace-node-macos-aarch64-mainnet-2026-jun-08 \
  run \
  --chain mainnet \
  --base-path "<BASE_PATH>" \
  --farmer \
...
```bash
./subspace-farmer-macos-aarch64-mainnet-2026-jun-08 farm --reward-address \"<REWARD_ADDRESS>\" path=\"<PATH_TO_FARM>,size=<FARM_SIZE>\"
```
