...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-node-ubuntu-x86_64-v2-mainnet-2025-dec-02
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-farmer-ubuntu-x86_64-v2-mainnet-2025-dec-02
		```
    </details>
    <details>
        <summary>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-node-ubuntu-x86_64-skylake-mainnet-2025-dec-02
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-dec-02
		```
    </details>
</details>
...
<details>
	...
	Node:
	```bash
	wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-node-ubuntu-aarch64-mainnet-2025-dec-02
	```
	Farmer:
	```bash
	wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2025-dec-02/subspace-farmer-ubuntu-aarch64-mainnet-2025-dec-02
	```
</details>
