...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-node-ubuntu-x86_64-v2-mainnet-2026-jun-14
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-farmer-ubuntu-x86_64-v2-mainnet-2026-jun-14
		```
    </details>
    <details>
        <summary>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-node-ubuntu-x86_64-skylake-mainnet-2026-jun-14
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-14
		```
    </details>
</details>
...
<details>
	...
	Node:
	```bash
	wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-node-ubuntu-aarch64-mainnet-2026-jun-14
	```
	Farmer:
	```bash
	wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-farmer-ubuntu-aarch64-mainnet-2026-jun-14
	```
</details>
