...
<ReleaseContainer>
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-node-ubuntu-x86_64-skylake-mainnet-2026-jun-14"
    title="Node Executable"
    subtitle="(Skylake+ CPU)" />
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-14"
...
<ReleaseContainer>
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-node-ubuntu-x86_64-v2-mainnet-2026-jun-14"
    title="Node Executable"
    subtitle="(Legacy CPU)" />
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-farmer-ubuntu-x86_64-v2-mainnet-2026-jun-14"
    title="Farmer Executable"
    subtitle="(Legacy CPU)" />
</ReleaseContainer>
...
<ReleaseContainer>
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-node-ubuntu-aarch64-mainnet-2026-jun-14"
    title="Node Executable"
    subtitle="(Aarch64/Raspberry Pi)" />
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-jun-14/subspace-farmer-ubuntu-aarch64-mainnet-2026-jun-14"
    title="Farmer Executable"
    subtitle="(Aarch64/Raspberry Pi)" />
</ReleaseContainer>
...
```bash
chmod +x subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-14
chmod +x subspace-node-ubuntu-x86_64-skylake-mainnet-2026-jun-14
```
...
```bash
./subspace-node-ubuntu-x86_64-skylake-mainnet-2026-jun-14 \
  run \
  --chain mainnet \
  --base-path "<BASE_PATH>" \
  --name "<NAME>" \
...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-14 farm \
