...
<ReleaseContainer>
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-aug-20/subspace-node-windows-x86_64-skylake-mainnet-2025-aug-20.exe" 
    title="Node Executable" 
    subtitle="(Skylake+ CPU)" />
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-aug-20/subspace-farmer-windows-x86_64-skylake-mainnet-2025-aug-20.exe" 
...
<ReleaseContainer>
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-aug-20/subspace-node-windows-x86_64-v2-mainnet-2025-aug-20.exe" 
    title="Node Executable" 
    subtitle="(Legacy CPU)" />
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2025-aug-20/subspace-farmer-windows-x86_64-v2-mainnet-2025-aug-20.exe" 
    title="Farmer Executable" 
    subtitle="(Legacy CPU)" />
</ReleaseContainer>
