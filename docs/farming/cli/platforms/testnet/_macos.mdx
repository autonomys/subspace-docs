...
:::caution Minimum macOS Version
  ...
  The minimum support macOS version is version 14+
...
<ReleaseContainer>
  ...
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-farmer-macos-aarch64-chronos-2026-jan-15.zip" title="Farmer Executable" subtitle="(Apple CPU)" />
</ReleaseContainer>
...
- `chmod +x subspace-farmer-macos-aarch64-chronos-2026-jan-15`
- `chmod +x subspace-node-macos-aarch64-chronos-2026-jan-15`
...
```bash
./subspace-node-macos-aarch64-chronos-2026-jan-15 \
  run \
  --chain chronos \
  --base-path "<BASE_PATH>" \
  --farmer \
...
```bash
./subspace-farmer-macos-aarch64-chronos-2026-jan-15 farm --reward-address "<REWARD_ADDRESS>" path="<PATH_TO_FARM>,size=<FARM_SIZE>"
```
