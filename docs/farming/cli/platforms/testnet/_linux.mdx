...
<ReleaseContainer>
  ...
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-jan-15" title="Farmer Executable" subtitle="(Skylake+ CPU)" />
</ReleaseContainer>
...
<ReleaseContainer>
  ...
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-farmer-ubuntu-x86_64-v2-chronos-2026-jan-15" title="Farmer Executable" subtitle="(Legacy CPU)" />
</ReleaseContainer>
...
<ReleaseContainer>
  ...
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-farmer-ubuntu-aarch64-chronos-2026-jan-15" title="Farmer Executable" subtitle="(Aarch64/Raspberry Pi)" />
</ReleaseContainer>
...
2. Make the `farmer` and `node` executable:
    ```bash
    chmod +x subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-jan-15
    chmod +x subspace-node-ubuntu-x86_64-skylake-chronos-2026-jan-15
    ```

3. Start the node using the command below:
    ...
    ```bash
    ./subspace-node-ubuntu-x86_64-skylake-chronos-2026-jan-15 \
      run \
      --chain chronos \
      --base-path "<BASE_PATH>" \
      --name "<NAME>" \
  ...
  :::
   ...
   You should see output similar to this in your terminal:
    ...
    2024-09-04T06:42:56.744231Z  INFO subspace_node::commands::run: ✌️  version 0.1.3-4ab03432144
    2024-09-04T06:42:56.744235Z  INFO subspace_node::commands::run: ❤️  by Subspace Labs <https://subspace.network>
    2024-09-04T06:42:56.744238Z  INFO subspace_node::commands::run: 📋 Chain specification: Autonomys Chronos Testnet
...
1. Open a new terminal and navigate to the directory where the Subspace farmer binary is located. Start the farmer with the following command:
    ...
    ```bash
    ./subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-jan-15 farm \
