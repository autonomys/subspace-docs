...
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-node-ubuntu-x86_64-skylake-taurus-2025-jul-14" title="Node Executable" subtitle="(Skylake+ CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-jul-14" title="Farmer Executable" subtitle="(Skylake+ CPU)" />
</ReleaseContainer>

<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-node-ubuntu-x86_64-v2-taurus-2025-jul-14" title="Node Executable" subtitle="(Legacy CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-farmer-ubuntu-x86_64-v2-taurus-2025-jul-14" title="Farmer Executable" subtitle="(Legacy CPU)" />
</ReleaseContainer>

<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-node-ubuntu-aarch64-taurus-2025-jul-14" title="Node Executable" subtitle="(Aarch64/Raspberry Pi)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/taurus-2025-jul-14/subspace-farmer-ubuntu-aarch64-taurus-2025-jul-14" title="Farmer Executable" subtitle="(Aarch64/Raspberry Pi)" />
</ReleaseContainer>
...
2. Make the `farmer` and `node` executable:
    ```bash
    chmod +x subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-jul-14
    chmod +x subspace-node-ubuntu-x86_64-skylake-taurus-2025-jul-14
    ```
...
3. Start the node using the command below:
    ...
    ```bash
    ./subspace-node-ubuntu-x86_64-skylake-taurus-2025-jul-14 \
      run \
      --chain taurus \
      --base-path "<BASE_PATH>" \
      --name "<NAME>" \
...
1. Open a new terminal and navigate to the directory where the Subspace farmer binary is located. Start the farmer with the following command:
    ...
    ```bash
    ./subspace-farmer-ubuntu-x86_64-skylake-taurus-2025-jul-14 farm \
