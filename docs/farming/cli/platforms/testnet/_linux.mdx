...
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-node-ubuntu-x86_64-skylake-chronos-2026-jan-05" title="Node Executable" subtitle="(Skylake+ CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-jan-05" title="Farmer Executable" subtitle="(Skylake+ CPU)" />
</ReleaseContainer>

<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-node-ubuntu-x86_64-v2-chronos-2026-jan-05" title="Node Executable" subtitle="(Legacy CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-farmer-ubuntu-x86_64-v2-chronos-2026-jan-05" title="Farmer Executable" subtitle="(Legacy CPU)" />
</ReleaseContainer>

<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-node-ubuntu-aarch64-chronos-2026-jan-05" title="Node Executable" subtitle="(Aarch64/Raspberry Pi)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-farmer-ubuntu-aarch64-chronos-2026-jan-05" title="Farmer Executable" subtitle="(Aarch64/Raspberry Pi)" />
</ReleaseContainer>
...
2. Make the `farmer` and `node` executable:
    ```bash
    chmod +x subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-jan-05
    chmod +x subspace-node-ubuntu-x86_64-skylake-chronos-2026-jan-05
    ```
...
3. Start the node using the command below:
    ...
    ```bash
    ./subspace-node-ubuntu-x86_64-skylake-chronos-2026-jan-05 \
      run \
      --chain chronos \
      --base-path "<BASE_PATH>" \
      --name "<NAME>" \
...
1. Open a new terminal and navigate to the directory where the Subspace farmer binary is located. Start the farmer with the following command:
    ...
    ```bash
    ./subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-jan-05 farm \
