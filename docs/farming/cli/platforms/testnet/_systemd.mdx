...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-node-ubuntu-x86_64-v2-chronos-2026-aug-18
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-farmer-ubuntu-x86_64-v2-chronos-2026-aug-18
		```
    </details>
    <details>
        <summary>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-node-ubuntu-x86_64-skylake-chronos-2026-aug-18
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-aug-18
		```
    </details>
</details>
...
<details>
	...
	Node:
	```bash
	wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-node-ubuntu-aarch64-chronos-2026-aug-18
	```
	Farmer:
	```bash
	wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-farmer-ubuntu-aarch64-chronos-2026-aug-18
	```
</details>
