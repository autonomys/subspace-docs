...
<details>
   <summary>
    ...
    <details>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-node-ubuntu-x86_64-v2-chronos-2026-jan-15
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-farmer-ubuntu-x86_64-v2-chronos-2026-jan-15
		```
    </details>
    <details>
        <summary>
		...
		Node:
		```bash
		wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-node-ubuntu-x86_64-skylake-chronos-2026-jan-15
		```
		Farmer:
		```bash
		wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-farmer-ubuntu-x86_64-skylake-chronos-2026-jan-15
		```
    </details>
</details>
...
<details>
	...
	Node:
	```bash
	wget -O ~/.local/bin/subspace-node https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-node-ubuntu-aarch64-chronos-2026-jan-15
	```
	Farmer:
	```bash
	wget -O ~/.local/bin/subspace-farmer https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-15/subspace-farmer-ubuntu-aarch64-chronos-2026-jan-15
	```
</details>
