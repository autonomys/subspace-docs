...
<ReleaseContainer>
  ...
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-farmer-windows-x86_64-skylake-chronos-2026-aug-18.exe" title="Farmer Executable" subtitle="(Skylake+ CPU)" />
</ReleaseContainer>
...
<ReleaseContainer>
  ...
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-aug-18/subspace-farmer-windows-x86_64-v2-chronos-2026-aug-18.exe" title="Farmer Executable" subtitle="(Legacy CPU)" />
</ReleaseContainer>
...
```powershell
.\subspace-node-windows-x86_64-skylake-chronos-2026-aug-18.exe `
  run `
  --chain chronos `
  --base-path "<BASE_PATH>" `
  --farmer `
...
```PowerShell
.\subspace-farmer-windows-x86_64-skylake-chronos-2026-aug-18.exe farm --reward-address "<REWARD_ADDRESS>" path="<PATH_TO_FARM>,size=<FARM_SIZE>"
```
