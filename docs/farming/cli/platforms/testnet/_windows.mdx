...
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-node-windows-x86_64-skylake-chronos-2026-jan-05.exe" title="Node Executable" subtitle="(Skylake+ CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-farmer-windows-x86_64-skylake-chronos-2026-jan-05.exe" title="Farmer Executable" subtitle="(Skylake+ CPU)" />
</ReleaseContainer>
 
<ReleaseContainer>
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-node-windows-x86_64-v2-chronos-2026-jan-05.exe" title="Node Executable" subtitle="(Legacy CPU)" />
  <ReleaseButton to="https://github.com/autonomys/subspace/releases/download/chronos-2026-jan-05/subspace-farmer-windows-x86_64-v2-chronos-2026-jan-05.exe" title="Farmer Executable" subtitle="(Legacy CPU)" />
</ReleaseContainer>
...
```powershell
.\subspace-node-windows-x86_64-skylake-chronos-2026-jan-05.exe `
  run `
  --chain chronos `
  --base-path "<BASE_PATH>" `
  --farmer `
...
2022-02-03 10:52:23 ✌️  version 0.1.3-4ab03432144
2022-02-03 10:52:23 ❤️  by Subspace Labs <https://subspace.network>
2022-02-03 10:52:23 📋 Chain specification: Autonomys Chronos Testnet
...
```PowerShell
.\subspace-farmer-windows-x86_64-skylake-chronos-2026-jan-05.exe farm --reward-address "<REWARD_ADDRESS>" path="<PATH_TO_FARM>,size=<FARM_SIZE>"
```
