...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-dec-02 wipe <PATH_TO_FARM>
./subspace-node-ubuntu-x86_64-skylake-mainnet-2025-dec-02 wipe <BASE_PATH>
```
...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-dec-02 farm --reward-address "<REWARD_ADDRESS>" \
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-dec-02 benchmark audit <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-dec-02 benchmark prove <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2025-dec-02 scrub <PATH_TO_FARM>
```
