...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-08 wipe <PATH_TO_FARM>
./subspace-node-ubuntu-x86_64-skylake-mainnet-2026-jun-08 wipe <BASE_PATH>
```
...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-08 farm --reward-address "<REWARD_ADDRESS>" \
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-08 benchmark audit <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-08 benchmark prove <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-jun-08 scrub <PATH_TO_FARM>
```
