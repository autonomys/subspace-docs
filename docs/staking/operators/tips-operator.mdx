...
```bash
./subspace-node-ubuntu-x86_64-skylake-chronos-2026-aug-18 domain key insert \
...
```bash
./subspace-node-ubuntu-x86_64-skylake-chronos-2026-aug-18 run \
--chain chronos \
--farmer \
--name "<NAME>" \
--base-path "<BASE_PATH>" \
...
```powershell
.\subspace-node-windows-x86_64-skylake-chronos-2026-aug-18.exe run `
--chain chronos `
--farmer `
--name "<NAME>" `
--base-path "<BASE_PATH>" `
...
```bash
./subspace-node-macos-aarch64-chronos-2026-aug-18 run \
--chain chronos \
--farmer \
--name "<NAME>" \
--base-path "<BASE_PATH>" \
