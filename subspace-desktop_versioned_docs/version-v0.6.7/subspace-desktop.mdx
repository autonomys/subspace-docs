...
<Tabs>
    <TabItem value="windows" label="🖼️ Windows" default>
        <div className={styles.buttons}>
            ...
            to="https://github.com/subspace/subspace-desktop/releases/download/0.6.7/subspace-desktop_0.6.7_x64_en-US.msi">
    ...
    <TabItem value="macOS" label="🍎 macOS" default>
        <div className={styles.buttons}>
            <Link
            className="button button--secondary button--lg"
            to="https://github.com/subspace/subspace-desktop/releases/download/0.6.7/subspace-desktop_0.6.7_x64.dmg">
    ...
    <TabItem value="linux" label="🐧 Linux" default>
        <div className={styles.buttons}>
            <Link
            className="button button--secondary button--lg"
            to="https://github.com/subspace/subspace-desktop/releases/download/0.6.7/subspace-desktop_0.6.7_amd64.deb">
            Subspace-Desktop.deb
            </Link>
            <Link
            className="button button--secondary button--lg"
            to="https://github.com/subspace/subspace-desktop/releases/download/0.6.7/subspace-desktop_0.6.7_amd64.AppImage">
            Subspace-Desktop.AppImage
            </Link>
            <Link
            className="button button--secondary button--lg"
            to="https://github.com/subspace/subspace-desktop/releases/download/0.6.7/subspace-desktop.app.tar.gz">
...
1. Download the latest for your preferred platform from above.
