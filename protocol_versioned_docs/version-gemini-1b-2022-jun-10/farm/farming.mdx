...
<TabItem value="windows" label="🖼️ Windows" default>
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-node-windows-x86_64-gemini-1b-2022-jun-10.exe">
      1. Download Node Executable
    </Link>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-farmer-windows-x86_64-gemini-1b-2022-jun-10.exe">
  ...
  .\subspace-node-windows-x86_64-gemini-1b-2022-jun-10.exe `
  --chain gemini-1 `
  --execution wasm `
  --pruning 1024 `
  --keep-blocks 1024 `
  ...
  # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for instance 100G or 2T (but leave at least 10G of disk space for node)
  .\subspace-farmer-windows-x86_64-gemini-1b-2022-jun-10.exe.exe farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
  ```
...
<TabItem value="macos" label="🍎macOS" default>
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-node-macos-x86_64-gemini-1b-2022-jun-10.zip">
      1. Download Node Executable
    </Link>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-farmer-macos-x86_64-gemini-1b-2022-jun-10.zip">
      2. Download Farmer Executable
    </Link>
  </div>
  ...
  - `chmod +x subspace-farmer-macos-x86_64-gemini-1b-2022-jun-10`
  - `chmod +x subspace-node-macos-x86_64-gemini-1b-2022-jun-10`
  3. We will then start the node using the following command
  ...
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-macos-x86_64-gemini-1b-2022-jun-10 \
    --chain gemini-1 \
    --execution wasm \
    --pruning 1024 \
    --keep-blocks 1024 \
  ...
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for instance 100G or 2T (but leave at least 10G of disk space for node)
  ./subspace-farmer-macos-x86_64-gemini-1b-2022-jun-10 farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
  ```
...
<TabItem value="linux" label="🐧Ubuntu">
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-node-ubuntu-x86_64-gemini-1b-2022-jun-10">
      1. Download Node Executable
    </Link>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jun-10">
      2. Download Farmer Executable
    </Link>
  </div>
  <p>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-node-ubuntu-aarch64-gemini-1b-2022-jun-10">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-10/subspace-farmer-ubuntu-aarch64-gemini-1b-2022-jun-10">
        2. Download Farmer Executable
      </Link>
    </div>
  </details>
  ...
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-ubuntu-x86_64-gemini-1b-2022-jun-10 \
  --chain gemini-1 \
  --execution wasm \
  --pruning 1024 \
  --keep-blocks 1024 \
  ...
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for instance 100G or 2T (but leave at least 10G of disk space for node)
  ./subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jun-10 farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
  ```
...
**Example:**
```
.\subspace-node-ubuntu-x86_64-gemini-1b-2022-jun-10 --chain gemini-1 --base-path /path/to/directory/here --execution wasm --pruning 1024 --keep-blocks 1024 --validator --name INSERT_YOUR_ID
```
</TabItem>
...
**Example:**
```
.\subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jun-10 --base-path /path/to/directory/here farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
```
</TabItem>
</Tabs>
