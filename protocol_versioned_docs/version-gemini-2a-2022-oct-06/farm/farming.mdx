...
**Example:**
```
.\subspace-node-ubuntu-x86_64-gemini-2a-2022-oct-06 --chain gemini-2a --base-path /path/to/directory/here --execution wasm --state-pruning archive --validator --name INSERT_YOUR_ID
```
</TabItem>
