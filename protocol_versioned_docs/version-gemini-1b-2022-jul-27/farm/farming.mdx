...
<TabItem value="windows" label="🖼️ Windows" default>
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-node-windows-x86_64-gemini-1b-2022-jul-27.exe">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-farmer-windows-x86_64-gemini-1b-2022-jul-27.exe">
      Download Farmer Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-farmer-opencl-windows-x86_64-gemini-1b-2022-jul-27.exe">
  ...
  .\subspace-farmer-windows-x86_64-gemini-1b-2022-jul-27.exe.exe farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
  ```
...
<TabItem value="macos" label="🍎macOS" default>
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-node-macos-x86_64-gemini-1b-2022-jul-27.zip">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-farmer-macos-x86_64-gemini-1b-2022-jul-27.zip">
      Download Farmer Executable
    </Link>
  </div>
  ...
  - `chmod +x subspace-farmer-macos-x86_64-gemini-1b-2022-jul-27`
  - `chmod +x subspace-node-macos-x86_64-gemini-1b-2022-jul-27`
  3. We will then start the node using the following command
  ...
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for instance 100G or 2T (but leave at least 10G of disk space for node)
  ./subspace-farmer-macos-x86_64-gemini-1b-2022-jul-27 farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
  ```
...
<TabItem value="linux" label="🐧Ubuntu">
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-node-ubuntu-x86_64-gemini-1b-2022-jul-27">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jul-27">
      Download Farmer Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-farmer-opencl-ubuntu-x86_64-gemini-1b-2022-jul-27">
      Download Farmer Executable (OpenCL)
    </Link>
  </div>
  <p>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-node-ubuntu-aarch64-gemini-1b-2022-jul-27">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jul-27/subspace-farmer-ubuntu-aarch64-gemini-1b-2022-jul-27">
  ...
  1. Open your favorite terminal, and change to the Downloads directory using `cd Downloads`
  2. Make the farmer & node executable
  - `chmod +x subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jul-27`
  - `chmod +x subspace-node-ubuntu-x86_64-gemini-1b-2022-jul-27`
  3. We will then start the node using the following command
  ...
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  # Replace `PLOT_SIZE` with plot size in gigabytes or terabytes, for instance 100G or 2T (but leave at least 10G of disk space for node)
  ./subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jul-27 farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
  ```
...
**Example:**
```
.\subspace-node-ubuntu-x86_64-gemini-1b-2022-jul-27 --chain gemini-1 --base-path /path/to/directory/here --execution wasm --pruning 1024 --keep-blocks 1024 --validator --name INSERT_YOUR_ID
```
</TabItem>
...
**Example:**
```
.\subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jul-27 --base-path /path/to/directory/here farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
```
</TabItem>
</Tabs>
