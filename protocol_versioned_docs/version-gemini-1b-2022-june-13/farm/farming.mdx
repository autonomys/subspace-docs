...
<TabItem value="windows" label="🖼️ Windows" default>
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-node-windows-x86_64-gemini-1b-2022-jun-13.exe">
      1. Download Node Executable
    </Link>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-farmer-windows-x86_64-gemini-1b-2022-jun-13.exe">
...
<TabItem value="macos" label="🍎macOS" default>
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-node-macos-x86_64-gemini-1b-2022-jun-13.zip">
      1. Download Node Executable
    </Link>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-farmer-macos-x86_64-gemini-1b-2022-jun-13.zip">
      2. Download Farmer Executable
    </Link>
  </div>
  ...
  - `chmod +x subspace-farmer-macos-x86_64-gemini-1b-2022-jun-13`
  - `chmod +x subspace-node-macos-x86_64-gemini-1b-2022-jun-13`
  3. We will then start the node using the following command
...
<TabItem value="linux" label="🐧Ubuntu">
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-node-ubuntu-x86_64-gemini-1b-2022-jun-13">
      1. Download Node Executable
    </Link>
    <Link
      className="button button--secondary button--lg"
      to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jun-13">
      2. Download Farmer Executable
    </Link>
  </div>
  <p>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-node-ubuntu-aarch64-gemini-1b-2022-jun-13">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-jun-13/subspace-farmer-ubuntu-aarch64-gemini-1b-2022-jun-13">
        2. Download Farmer Executable
      </Link>
    </div>
  </details>
  ...
  1. Open your favorite terminal, and change to the Downloads directory using `cd Downloads`
  2. Make the farmer & node executable
  - `chmod +x subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jun-13`
  - `chmod +x subspace-node-ubuntu-x86_64-gemini-1b-2022-jun-13`
  3. We will then start the node using the following command
...
**Example:**
```
.\subspace-node-ubuntu-x86_64-gemini-1b-2022-jun-13 --chain gemini-1 --base-path /path/to/directory/here --execution wasm --pruning 1024 --keep-blocks 1024 --validator --name INSERT_YOUR_ID
```
</TabItem>
...
**Example:**
```
.\subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jun-13 --base-path /path/to/directory/here farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
```
</TabItem>
</Tabs>
