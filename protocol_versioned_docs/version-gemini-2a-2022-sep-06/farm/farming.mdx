...
<TabItem value="windows" label="🖼️ Windows" default>
  <div className={styles.buttons}>
    <Link
      ...
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-node-windows-x86_64-gemini-2a-2022-sep-06.exe">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-farmer-windows-x86_64-gemini-2a-2022-sep-06.exe">
      Download Farmer Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-farmer-opencl-windows-x86_64-gemini-2a-2022-sep-06.exe">
  ...
  .\subspace-node-windows-x86_64-gemini-2a-2022-sep-06.exe `
  --chain gemini-2a `
  --execution wasm `
  --state-pruning archive `
  --validator `
  ...
  6. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
    *Change command to feature `subspace-farmer-opencl-windows-x86_64-gemini-2a-2022-sep-06.exe` if using Open CL version.*
  ```PowerShell
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  .\subspace-farmer-windows-x86_64-gemini-2a-2022-sep-06.exe farm  `
  --reward-address WALLET_ADDRESS `
  --plot-size 100G
  ```
...
<TabItem value="macos" label="🍎macOS" default>
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-node-macos-x86_64-gemini-2a-2022-sep-06.zip">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-farmer-macos-x86_64-gemini-2a-2022-sep-06.zip">
      Download Farmer Executable
    </Link>
  </div>
  ...
  - `chmod +x subspace-farmer-macos-x86_64-gemini-2a-2022-sep-06`
  - `chmod +x subspace-node-macos-x86_64-gemini-2a-2022-sep-06`
  3. We will then start the node using the following command
  ...
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-macos-x86_64-gemini-2a-2022-sep-06 \
    --chain gemini-2a \
    --execution wasm \
    --state-pruning archive \
    --validator \
  ...
  ```bash
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  ./subspace-farmer-macos-x86_64-gemini-2a-2022-sep-06 farm \
  --reward-address WALLET_ADDRESS \
  --plot-size 100G
  ```
...
<TabItem value="linux" label="🐧Ubuntu">
  <div className={styles.buttons}>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-node-ubuntu-x86_64-gemini-2a-2022-sep-06">
      Download Node Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-farmer-ubuntu-x86_64-gemini-2a-2022-sep-06">
      Download Farmer Executable
    </Link>
    <Link
      className="button button--secondary button"
      to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-farmer-opencl-ubuntu-x86_64-gemini-2a-2022-sep-06">
      Download Farmer Executable (OpenCL)
    </Link>
  </div>
  <p>
  ...
  <details>
    ...
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-node-ubuntu-aarch64-gemini-2a-2022-sep-06">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button"
        to="https://github.com/subspace/subspace/releases/download/gemini-2a-2022-sep-06/subspace-farmer-ubuntu-aarch64-gemini-2a-2022-sep-06">
  ...
  # Replace `INSERT_YOUR_ID` with a nickname you choose
  # Copy all of the lines below, they are all part of the same command
  ./subspace-node-ubuntu-x86_64-gemini-2a-2022-sep-06 \
    --chain gemini-2a \
    --execution wasm \
    --state-pruning archive \
    --validator \
  ...
  ```
  5. We will then open another terminal, change to the downloads directory, then start the farmer node with the following command:
      *Change command to feature `subspace-farmer-opencl-ubuntu-x86_64-gemini-2a-2022-sep-06` if using openCL.* 
  ```bash
  # Replace `FARMER_FILE_NAME` with the name of the farmer file you downloaded from releases
  # Replace `WALLET_ADDRESS` below with your account address from Polkadot.js wallet
  ./subspace-farmer-ubuntu-x86_64-gemini-2a-2022-sep-06 farm \
  --reward-address WALLET_ADDRESS \
  --plot-size 100G
  ```
...
**Example:**
```
.\subspace-node-ubuntu-x86_64-gemini-2a-2022-sep-06 --chain gemini-1 --base-path /path/to/directory/here --execution wasm --pruning 1024 --keep-blocks 1024 --validator --name INSERT_YOUR_ID
```
</TabItem>
...
**Example:**
```
.\subspace-farmer-ubuntu-x86_64-gemini-2a-2022-sep-06 --base-path /path/to/directory/here farm --reward-address WALLET_ADDRESS --plot-size PLOT_SIZE
```
</TabItem>
</Tabs>
