...
<Tabs groupId="OS">
  <TabItem value="windows" label="🖼️Windows" default>
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-node-windows-x86_64-gemini-1b-2022-june-05.exe">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-farmer-windows-x86_64-gemini-1b-2022-june-05.exe">
  ...
  <TabItem value="macos" label="🍎macOS" default>
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-node-macos-x86_64-gemini-1b-2022-june-05.zip">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-farmer-macos-x86_64-gemini-1b-2022-june-05.zip">
        2. Download Farmer Executable
      </Link>
    </div>
  </TabItem>
  ...
  <TabItem value="linux" label="🐧Linux" default>
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-node-ubuntu-x86_64-gemini-1b-2022-june-05">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-farmer-ubuntu-x86_64-gemini-1b-2022-june-05">
        2. Download Farmer Executable
      </Link>
    </div>
  </TabItem>
  ...
  <TabItem value="arm" label="🦾Arm" default>
    <div className={styles.buttons}>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-node-ubuntu-aarch64-gemini-1b-2022-june-05">
        1. Download Node Executable
      </Link>
      <Link
        className="button button--secondary button--lg"
        to="https://github.com/subspace/subspace/releases/download/gemini-1b-2022-june-05/subspace-farmer-ubuntu-aarch64-gemini-1b-2022-june-05">
        2. Download Farmer Executable
      </Link>
    </div>
  </TabItem>
...
We are regularly releasing stable snapshots. Our CI builds container images and executables for 4 major platforms (Windows, macOS, Linux, & Arm).

There are two files we are downloading:
- **Subspace Node**
- **Subspace Farmer**
...
### B. Follow OS Installation Guide
...
Now that your Node & Farmer have been started you will wait for the node to sync and the farmer to complete the initial plotting.
